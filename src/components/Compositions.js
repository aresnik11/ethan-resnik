...
const Compositions = () => {
    return (
        <div className="white-container">
            ...
            <br/><br/>
            <h2 className="subheading" id="rush">Rush</h2>
            ...
            <iframe title="Rush" src="https://www.youtube.com/embed/6ulRo1zm8ic" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
            <br/><br/>
            ...
            <h2 className="subheading" id="arrival">Arrival</h2>
            <p><a href="https://youtu.be/sUVj3l9MF70" target="_blank" rel="noopener noreferrer">Performance by the Akron Symphonic Winds</a></p>
            <iframe title="Arrival - Akron Symphonic Winds" src="https://www.youtube.com/embed/sUVj3l9MF70" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
            <br/><br/><br/>
            ...
            <h2 className="subheading" id="blue-moonlight">Blue Moonlight</h2>
            ...
            <br/><br/>
            <h2 className="subheading" id="winter-flashbacks">Winter Flashbacks - Cello and Piano</h2>
            ...
            <h2 className="subheading" id="graduation-eve">Graduation Eve - Oboe/Soprano Saxophone and Piano</h2>
            <p><a href="https://youtu.be/Dr_0K5ae6ck" target="_blank" rel="noopener noreferrer">Live Recording</a></p>
            <iframe title="Graduation Eve" src="https://www.youtube.com/embed/Dr_0K5ae6ck" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
            <br/><br/>
