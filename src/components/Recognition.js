...
import yonkers from '../assets/Yonkers-Philharmonic-Orchestra.png'
import byram from '../assets/bhhs.png'
            ...
            <div className="rec-grid">
                ...
                <div>
                    <div>
                        ...
                        <img src={ap} alt="American Protégé" className="photo-small" />
                    </div>
                </div>
                <div>
                    <div>
                        <h2 className="small-subheading">Yonkers Philharmonic Concerto Competition Finalist</h2>
                        <img src={yonkers} alt="Yonkers Philharmonic Concerto" className="photo-medium" />
                    </div>
                </div>
                <div>
                    <div>
                ...
                <div>
                    <div>
                        ...
                        <img src={byram} alt="Byram Hills High School" className="photo-small" />
                    </div>
                </div>
                <div>
                    <div>
                        <h2 className="small-subheading">New England Music Camp Phi Mu Alpha Outstanding Musician Award</h2>
                        <img src={nemc_logo} alt="New England Music Camp" className="photo-small" />
                        <br/>
