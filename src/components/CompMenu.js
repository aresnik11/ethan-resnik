    ...
    return (
      <div>
        <Menu vertical id="compositions-menu">
          <Menu.Item>
            <Menu.Header as="a" href="#orchestra" className="content-header">
              Orchestra
            </Menu.Header>
            <Menu.Menu>
              <Menu.Item
          ...
          <Menu.Item>
            <Menu.Header as="a" href="#concert-band">
              Concert Band
            </Menu.Header>
            <Menu.Menu>
              <Menu.Item
          ...
          <Menu.Item>
            <Menu.Header as="a" href="#string-orchestra">
              String Orchestra
            </Menu.Header>
            <Menu.Menu>
              <Menu.Item
          ...
          <Menu.Item>
            <Menu.Header as="a" href="#chamber-music">
              Chamber Music
            </Menu.Header>
            <Menu.Menu>
              <Menu.Item
